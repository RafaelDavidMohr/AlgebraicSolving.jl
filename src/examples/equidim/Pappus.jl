# Benchmark for `equidimensional_decomposition` on the "Pappus" system.
...
R, (x, y, z, t, u, v, w, a, b, c, d, e) = polynomial_ring(QQ, ["x", "y", "z", "t", "u", "v", "w", "a", "b", "c", "d", "e"])
...
Rp, _ = polynomial_ring(GF(prime), ["x", "y", "z", "t", "u", "v", "w", "a", "b", "c", "d", "e"])
