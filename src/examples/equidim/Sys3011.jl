# Benchmark for `equidimensional_decomposition` on the "Sys3011" system.
...
function build_system(K)
    _, (A21, A31, A32, A41, A42, A43, B1, B2, B3, B4, C2, C3, C4) = polynomial_ring(K, ["A21", "A31", "A32", "A41", "A42", "A43", "B1", "B2", "B3", "B4", "C2", "C3", "C4"])
    return [
        B1 + B2 + B3 + B4 - 1,
        -A21 + C2,
        -A31 - A32 + C3,
